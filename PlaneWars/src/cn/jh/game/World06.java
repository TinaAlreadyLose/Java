...
public class World06 extends JPanel {
    ...
    private  Hero06 hero =new Hero06();
    ...
    public void shootArion() {
        shootIndex++;
        if (shootIndex % 30 == 0) {
            Bullet06[] bs=hero.shoot();
